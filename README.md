...
- **API Architecture**: Komunikasi *real-time* dengan scraper kustom [`hianime-api`](https://github.com/dksmadboy/hianime-api) dan [`Otakudesu & Kuramanime`](https://github.com/wajik45/wajik-anime-api)
