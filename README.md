...
- **API Architecture**: Komunikasi *real-time* dengan scraper kustom [`hianime-api`](https://github.com/ryanwtf88/hianime-api) dan [`Otakudesu & Kuramanime`](https://github.com/wajik45/wajik-anime-api)
