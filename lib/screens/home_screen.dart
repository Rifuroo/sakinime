...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: _buildSidebarDrawer(), // Keeping existing drawer logic if available, or placeholder
      body: Stack(
        children: [
          // Content
          RefreshIndicator(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: const Icon(Icons.search, size: 20, color: Color(0xFFE2E8F0)),
                              ),
                            ),
                          ],
                        ),
  ...
  Widget _buildMainHeader() {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 0).copyWith(bottom: 24),
      child: Row(
        children: [
          GestureDetector(
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.search_rounded, size: 22, color: Color(0xFFE2E8F0)),
            ),
          ),
        ],
      ),
  ...
  Widget _buildHeroCard() {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 20, vertical: 0).copyWith(bottom: 24),
      height: 120,
      decoration: BoxDecoration(
  ...
  Widget _buildSection({
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 0).copyWith(bottom: 16),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Column(
