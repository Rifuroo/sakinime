...
class VideoPlayerSettingsModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (kDebugMode) {
      print('🛠️ [MODAL] availableQualities: $availableQualities');
      print('🛠️ [MODAL] selectedQuality: $selectedQuality');
    }
    return Material(
              ...
              child: GestureDetector(
                ...
                child: GestureDetector(
                  onVerticalDragUpdate:
                      (details) {}, // Block vertical drags from passing through
                  onHorizontalDragUpdate:
                      (details) {}, // Block horizontal drags
                  child: Container(
                    ...
                    constraints: BoxConstraints(
                      maxHeight: MediaQuery.of(context).orientation ==
                          ...
                          ? MediaQuery.of(context).size.height *
                              0.5 // Increased height for new settings
  ...
  Widget _buildQualityGrid() {
    return Wrap(
      ...
      children: availableQualities.map((quality) {
        final label = quality['quality']?.toString() ??
